...
func init() { Register("/artist/unfollow", ArtistUnfollow) }

func ArtistUnfollow(params map[string]interface{}, cookies map[string]string, requestFn func(util.RequestConfig) (*util.Response, error)) (*util.Response, error) {
	...
	return requestFn(util.RequestConfig{
		URL:"/followservice/v3/unfollow_singer",Method:"POST",
